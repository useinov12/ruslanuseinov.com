...
const AboutPage = () => {
  return (
    <Layout>
      <h1 className="mb-8 mt-4">
        <Accent>About</Accent>
      </h1>
      <div className="w-full h-[1px] mb-8 mt-8 bg-gray-300 rounded-lg" />
      <section className="flex flex-col-reverse md:flex-row md:items-center md:justify-around mb-4">
        <div className="py-2 md:py-0">
          <h1 className="text-4xl font-bold">Ruslan Useinov</h1>
          <h4 className="mb-1">Front end developer</h4>
          <p className="text-gray-300">Creating beautiful and performant web</p>
        </div>
      ...
      <div className="flex flex-col-reverse md:flex-row justify-between ">
        <section className="py-1 font-semibold text-lg">
          ...
          <p className="py-2">
            ...
            considered myself a tech person enough to figure things out. Until I
            actually started reading and practicing with Javascript!
          </p>
          <p className="py-2">
          ...
          <p className="py-2">
            ...
            aspects of the web and I am motivated to learn as much as possible.
          </p>
          <p className=" py-2">
            Right now I want to master my skills and be as fluent as possible
            with modern frameworks and then invest more time in UX to learn how
            to design intuitive UI quickly, effectively, and scalable.
          </p>
          <p className=" py-3">
            Here I will be writing some notes and showcasing what I do. I
            believe that documenting is the best way to learn things, and I can
