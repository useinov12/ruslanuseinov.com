...
description: 'Personal website with blog using Next JS and Contentlayer SDK'
coverImage: ''
---
...
Next js provide you with best structure for React project.\
Makes develpement easy and fun.
...
To set up a [Table of Content](https://github.com/useinov12/ruslanuseinov.com/blob/main/src/components/content/PostContent.tsx),
...
```typescript:MDXComponents showLineNumbers
...
```javascript:Post.jsx showLineNumbers
