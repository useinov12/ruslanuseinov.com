---
title: 'Handaling Auth in Personal Finance project'
...
fetch and cashe User and session information.

React Query library provides an abstraction layer for handaling everething that
related to an API call from api state(loading/fetching, isSuccess, isError, etc) to esaly handaling database mutations.
It can fullfill all our needs for **authentification**
